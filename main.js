...
const clientId = "a0898cb5ef0a4649961d7a90f8428a95";
const clientSecret = "a3e456f832424473b116a7dc5dd9a6cc";

const _getToken = async () => {
    const result = await fetch(`https://accounts.spotify.com/api/token`, { //'fetch' is preferred better than axiom
        method: 'POST',
        headers: {
